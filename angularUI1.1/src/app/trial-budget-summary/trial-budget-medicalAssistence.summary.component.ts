...
@Component({
  selector: 'trial-budget-medicalAssistence-summary',
  templateUrl: './trial-budget-medicalAssistence.summary.component.html',
  styleUrls: ['./trial-budget-summary.component.css']
})
export class TrialBudgetMedicalSummaryComponent implements OnInit {
...
private _fb: FormBuilder, private constantsService: ConstantsService, private header: ScreeningHeaderComponent, private router: Router) {
    this.constantsService.subheaderTitle("Trial Budget: MA Financial Eligibility");
  }
