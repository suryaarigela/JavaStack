...
@Component({
  selector: 'app-trial-foodstamp-budget-summary',
  templateUrl: './trial-budget-foodStamps.summary.component.html',
  styleUrls: ['./trial-budget-summary.component.css']
})
export class TrialBudgetFoodStampSummaryComponent implements OnInit {
...
private _fb: FormBuilder, private constantsService: ConstantsService, private header: ScreeningHeaderComponent, private router: Router) {
    this.constantsService.subheaderTitle("Trial Budget: Food Stamps");
  }
